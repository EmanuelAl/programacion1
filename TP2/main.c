...
int menuInforms()
{
    ...
    printf("2-Show total salary , average wages ,how many employees exceed the average salary \n");
    printf("5- Get out\n");
    printf(" Enter option:");
    scanf("%d",&option);
...
void showEmployeeSalary(Employee x)//muestra un empleado
{
...
void printEmployeesSalary(Employee list[],int len)//muesstra los empleados
{
